Created an extension that caters to dyslexic people implementing the functionality of changing the background colours, increasing the font size and a TTS feature for selected text. 
